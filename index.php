...
<html>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    ...
                    <div class="sign col-lg-1 col-lg-push-1">
                    ...
                    <!--SEARCH BAR-->
                    <form class="col-lg-2 col-lg-push-2 navbar-form" role="search">
                    ...
                    <div class="cart col-lg-1 col-lg-push-2">
    ...
    <div class="container"><!--NOTE: MAKING HALF WIDTH PAGE CAROUSEL. THIS DIV IS TO CONTAIN BOTH CAROUSEL ON LEFT AND INFO PANEL ON RIGHT-->
        ...
        <div id="carousel" class="carousel slide col-lg-5 pull-left" data-ride="carousel">
            <!-- Indicators -->
        ...
        <div class="info col-lg-7 pull-right">
            <h1>SALE</h1>
            <h1>Up to 25% Off*</h1>
            <div class="salead">
...
<section id="sale" class="sale-section">
                    ...
                    <div class="saleitemrow">
                            ...
                            <div class="col-lg-3">
                                    <div class="thumbnail">
                                          ...
                                          <div class="styleinfo">
                                                <h3>Designer light blue print belted dress</h3>
                                                <p>Was €70.00</p> 
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-3">
                        <div class="thumbnail">
                              ...
                              <div class="styleinfo">
                                    ...
                                    <a class="page-scroll" href="#sale"><span class="glyphicon glyphicon-circle-arrow-right"></span></a>
                              </div>
                        </div>
                </div>
                ...
                <div class="col-sm-6 col-md-3">
                        <div class="thumbnail">
                              ...
                              <div class="styleinfo">
                                    <h4>Menswear SS15</h4>
                                    <p>From Gandy to Beckham: Men to red carpet round-ups, there's no denying the fact that men's fashion is well and truly on the up...</p>
                                    <a class="page-scroll" href="#sale"><span class="glyphicon glyphicon-circle-arrow-right"></span></a>
                              </div>
                        </div>
                </div>
    ...
    <!-- Contact Section NOTE: OLD CONTACT SECTION -->
    <!--<section class="contact-section">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="info col-lg-4 pull-left">
                        <h1>LONDON FASHION WEEK 2015</span></h1>
                        <p>Get all the insider gossip at LFW15.</p>
                    </div>

                    <div class="col-lg-8 pull-right">
                            <img src="img/lfw15.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
       ...
       <!-- <div class="advert-section">
            <div class="advert col-lg-5 pull-left">
